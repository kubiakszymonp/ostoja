...
export interface ApiHomepageSectionItemHomepageSectionItem
  extends Schema.CollectionType {
  collectionName: 'homepage_section_items';
  info: {
    singularName: 'homepage-section-item';
    pluralName: 'homepage-section-items';
    displayName: 'HomepageSectionItem';
    description: '';
  };
  options: {
    draftAndPublish: true;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::homepage-section-item.homepage-section-item': ApiHomepageSectionItemHomepageSectionItem;
    }
  }
}
